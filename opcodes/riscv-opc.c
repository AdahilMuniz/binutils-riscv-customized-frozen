...
/* Custom Vector Merge Instructions*/
{"vmconv.vv",   0, INSN_CLASS_V, "Vd,Vt,VsVm", MATCH_VMCONV_VV, MASK_VMCONV_VV, match_opcode, 0 },
{"vmconi.vv",   0, INSN_CLASS_V, "Vd,Vt,VsVm", MATCH_VMCONI_VV, MASK_VMCONI_VV, match_opcode, 0 },
